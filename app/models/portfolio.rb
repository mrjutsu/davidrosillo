class Portfolio < ActiveRecord::Base
	...
	has_attached_file :avatar, :styles => { :medium => "300x300>", :thumbnail => "360", :ipadthumbnail => "820", :ipadshow => "1024", :phonethumb => "600", :phoneshow => "736" }, :default_url => "/images/:style/missing.png"
